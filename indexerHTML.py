...
''')
        ...
        for root, dirs, files in os.walk(root_dir):
            ...
            # Write folder name at all levels, including root
            ...
            for filename in files:
                if filename.endswith('.html'):
                    ...
                    index_file.write(f'{indent}    <li><a href="{file_path}" target="file-viewer">{filename}</a></li>\n')
...
''')
    ...
    print("Formatted index file with iframe generated successfully.")
